				...
				<?php while(have_posts()) {
					the_post();?>
							<a class="no-underline" href="<?php echo the_permalink(); ?>">
								<div style="min-height:300px; display:flex; margin-bottom:20px;" class="btn btn-outline-light container-fluid row">
									<div class="col-xl-8 text-dark dont-underline">
										<h2 class="text-left font-weight-bold"><?php echo the_title(); ?></h2>
										<h3 class="text-left"><?php echo the_field('preview_text', get_the_ID());?></h3>
										<h2 class="text-left font-weight-bold"><?php echo the_field('price', get_the_ID());?></h2>
									</div>
									<div class="col-xl-4">
